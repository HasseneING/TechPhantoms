...
public class AppointementController implements Initializable {
    ...
    public void CreateAppointement(DateTime start_reservation, DateTime end_reservation) throws IOException, GeneralSecurityException, SQLException {
        ...
        if (existe == false) {
            ...
            URL url = new File("src/main/java/fxml/Student/ValidAlert.fxml").toURI().toURL();
            showAlert(url);
        } else {
            URL url = new File("src/main/java/fxml/Student/InvalidAlert.fxml").toURI().toURL();
            showAlert(url);
        }
    ...
    public void showAlert(URL url) throws IOException {
