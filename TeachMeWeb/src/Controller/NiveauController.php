...
class NiveauController extends AbstractController
{
    ...
    /**
     * @Route("/niveauFront", name="niveauFront", methods={"GET"})
     */
    public function indexfront(NiveauRepository $niveauRepository): Response
    {
        return $this->render('niveau/front.html.twig', [
            'niveaux' => $niveauRepository->findAll(),
        ]);
    }
    ...
    /**
     * @Route("/{idN}", name="niveau_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idN}/edit", name="niveau_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{idN}", name="niveau_delete", methods={"POST"})
     */
    public function delete(Request $request, Niveau $niveau): Response
    {
        if ($this->isCsrfTokenValid('delete'.$niveau->getIdN(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
    ...
    public function sortByTitleASC(NiveauRepository $niveauRepository): Response
    {
        ...
        $niveaux=$niveauRepository->sortByTitleASC();
