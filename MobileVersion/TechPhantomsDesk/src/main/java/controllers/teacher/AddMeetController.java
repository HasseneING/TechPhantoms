...
public class AddMeetController implements Initializable {
    ...
    public void sendMail(String toEmail,String link){
        ...
        EmailUtils.sendEmail(session, toEmail,"Appointement with tutor", "MeetLink = "+link+"\n"+"Meet Pass="+meet_pass.getText());
