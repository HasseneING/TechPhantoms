...
public class FXMLDocumentController implements Initializable {
    ...
    */
    ...
    public List<Meet> readAll() throws SQLException {
        ...
        String req = "select username,meet_id,tutorid_id,studentid_id,meet_link,meet_date,meet_pass,meet_name from meet INNER JOIN student ON student.id = meet.studentid_id where tutorid_id=1 AND meet_date >= NOW()";
